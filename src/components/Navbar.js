      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
            <Link className="nav-link" to="/about">{props.aboutText}</Link>{/* Use curly braces to insert props */}
            </li>
          </ul>
...
Navbar.propTypes = {
  ...
  aboutText: PropTypes.string.isRequired, // Define aboutText as a prop
};
